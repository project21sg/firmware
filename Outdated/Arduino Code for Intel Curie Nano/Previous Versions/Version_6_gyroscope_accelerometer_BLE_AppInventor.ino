...
BLEIntCharacteristic AccChar("00002a19-0000-1000-8000-00805f9b34fb", BLERead | BLENotify);
...
void setup() {
  ...
  blePeripheral.addAttribute(AccService);  //add service
