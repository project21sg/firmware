...
BLEService GaitSensor2("19B10010-E8F2-537E-4F6C-D104768A1215"); // BLE AnalogRead Service

// BLE LED Switch Characteristic - custom 128-bit UUID, read and writable by central
BLEUnsignedIntCharacteristic SensorStatus2("19B10011-E8F2-537E-4F6C-D104768A1215", BLERead | BLEWrite  );
...
void setup() {
  ...
  blePeripheral.setLocalName("GaitSensor2");
  blePeripheral.setAdvertisedServiceUuid(GaitSensor2.uuid());

  // add service and characteristic:
  blePeripheral.addAttribute(GaitSensor2);
  blePeripheral.addAttribute(SensorStatus2);
  ...
  microsNow = micros();
    ...
    if (central) {   
      ...
      {     
        ...
        if(SensorStatus2.written())
        {
          switchcontrol = SensorStatus2.value();
        }
